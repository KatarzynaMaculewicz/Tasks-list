  ...
  const render = () => {
    ...
    for (const task of tasks) {
      htmlString += `
          ...
          <button class="tasks_button tasks_button--toggleDone js-done">${task.done ? "✔" : ""}</button>
          <span class="tasks_name${task.done ? "tasks_name tasks_name--done" : ""}">${task.content}</span>
